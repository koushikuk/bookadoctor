...
var server = http.createServer(function(req, res) {
    ...
    res.end(fs.readFileSync(__dirname + '/adjudication_queue'));
...
var ddbStream = new DynamoDBStream(new aws.DynamoDBStreams(), 'arn:aws:dynamodb:us-east-1:432070650247:table/telos-application-dev/stream/2017-04-07T11:50:59.449')
 
var localState = {}
 
ajax_request({
	  url: 'http://dev.telosid-rewards-drupal.com/adjudication_encdecrypt',
	  method: 'GET',
	   data: {
		   query1: '7calvMEVIb3INpY6qaNJUg==',
	   },
	    }, function(err, res, body) {
	     console.log(body);
		 console.log(var url = require('url'););
