...
$config = array(
    ...
    'default-sp' => array(
        ...
        'idp' => 'https://telr-mkt-dev.inadev.net/simplesaml/saml2/idp/metadata.php',
    ...
    'drupal-userpass' => array(
        ...
        'drupal_logout_url' => 'https://telr-mkt-dev.inadev.net/user/logout',

        // the URL of the Drupal login page
        'drupal_login_url' => 'https://telr-mkt-dev.inadev.net/user',
