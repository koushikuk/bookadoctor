...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://telr-mkt-dev.inadev.net/simplesaml/',
    'certdir' => 'cert/',
    'loggingdir' => 'log/',
    'datadir' => 'data/',
     ...
     */
    'database.dsn' => 'mysql:host=telr-db-dev-mkt-rds.cvuj1mkzly9g.us-east-1.rds.amazonaws.com;port=4306;dbname=telrdevmktdb',

    /*
     * SQL database credentials
     */
    'database.username' => 'telrdevmkt',
    'database.password' => 'KncCgxAZDqLxYQsP',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:host=telr-db-dev-mkt-rds.cvuj1mkzly9g.us-east-1.rds.amazonaws.com;port=4306;dbname=telrdevmktdb',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'telrdevmkt',
    'store.sql.password' => 'KncCgxAZDqLxYQsP',
